...
IMG_SIZE = 256                 # Taille de redimensionnement (ex: 128x128)
BATCH_SIZE = 32                # Nombre d'images traitées à la fois
EPOCHS = 150                   # Nombre d'aller-retours d'entraînement

DIR_SAVE = "model/blur_2"                                       # Dossier de sauvegarde des modèles et historiques
MODEL_SAVE_PATH = f"{DIR_SAVE}/best_model_blur_2.h5"            # Sauvegardera UNIQUEMENT le meilleur
CSV_HISTORY_PATH = f"{DIR_SAVE}/training_history_blur_2.csv"    # Fichier d'historique des épochs
# ==============================================================================
