...
SAVE_DIR = "model/fakv6"
os.makedirs(SAVE_DIR, exist_ok=True)  # Crée le dossier 'model/fakv6' s'il n'existe pas
...
checkpoint_path = os.path.join(SAVE_DIR, "fakv6_model_e{epoch}.h5")
...
# --- SAUVEGARDE FINALE ---
final_save_path = os.path.join(SAVE_DIR, "fakv6_model_eFinal.h5")
