...
LEARNING_RATE = 0.001
NUM_CLASSES = 5 
MODEL_SAVE_NAME = "model/fakv3_model.h5"
...
# Calcul de l'index de séparation pour la validation
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dropout(0.4), # Un peu moins agressif que 0.5
...
history = model.fit(
    train_ds,
    validation_data=val_ds, # Le modèle s'évalue sur val_ds à chaque fin d'époque
    epochs=EPOCHS,
