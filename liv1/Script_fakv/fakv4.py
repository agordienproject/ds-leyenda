...
LEARNING_RATE = 0.001
NUM_CLASSES = 5 
VALIDATION_SPLIT = 0.2      # Remis à sa place ici !

# Configuration des dossiers et noms de sauvegarde
SAVE_DIR = "model/fakv4"
os.makedirs(SAVE_DIR, exist_ok=True)  # Crée le dossier 'model/fakv4' s'il n'existe pas
...
model = tf.keras.Sequential([
    ...
    # 1. Augmentation de données (ne s'active qu'à l'entraînement)
    ...
    # LA CLÉ : GlobalAveragePooling au lieu de Flatten
...
checkpoint_path = os.path.join(SAVE_DIR, "fakv4_model_e{epoch}.h5")
...
# --- SAUVEGARDE FINALE ---
final_save_path = os.path.join(SAVE_DIR, "fakv4_model_eFinal.h5")
